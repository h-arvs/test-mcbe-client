// from nuvola by ASM thx thx thx :))))))

#pragma once

#ifdef ENTT_ENTITY_FWD_HPP
static_assert(false, "NAH U FUCKED UP DA INCLOODS!!!");
//Ok for real tho u gotta make sure this is included *before* entt's actual fwd header!!
//This modified version fixes stuff and things for use in Minecraft
#endif
